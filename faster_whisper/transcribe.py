...
# Import utils lazily to avoid import-time failure if optional dependencies (e.g. requests) are missing
try:
    ...
    # Define lazy wrappers that import utils when the functions are actually used.
